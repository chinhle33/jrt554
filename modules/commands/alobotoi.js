...
module.exports.languages = {
  "vi": {
    "on": "Bật",
    "off": "Tắt",
    "successText": "alobotoi thành công",
  },
  "en": {
    "on": "on",
    "off": "off",
    "successText": "alobotoi success!",
  }
}
...
module.exports.run = async function ({ api, event, Threads, getText }) {
  ...
  if (typeof data["alobotoi"] == "undefined" || data["alobotoi"] == true) data["alobotoi"] = false;
  else data["alobotoi"] = true;

  await Threads.setData(threadID, { data });
  global.data.threadData.set(threadID, data);
  return api.sendMessage(`${(data["alobotoi"] == false) ? getText("off") : getText("on")} ${getText("successText")}`, threadID, messageID);
}