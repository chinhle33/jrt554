...
module.exports.run = async ({ event, api, args, Threads }) => {
  ...
  try {
    if(global.client.family2 == true) return api.sendMessage("Hệ thống đang xử lý yêu cầu từ box khác, vui lòng quay lại sau", event.threadID, event.messageID);
  ...
  catch(e) {global.client.family2 = false};
}
